...
class InteractiveConfig:
    ...
    def run(self):
        ...
        # path input
        path_label = Label(self.window,
                           text="Please enter the path of the smear you want to analyse \n (e.g. TB_sample/extern_Synlab_2156_17_3_MTB.czi)")
        ...
        # tile input
        tile_label = Label(self.window,
                           text="Please enter the number of the tile you want to analyse, \n write None for analysing the whole smear.")
        ...
        algorithm_label = Label(self.window,
                                text="Please select a thresholding algorithm: \n hard, otsu, adaptive_gaussian, adaptive_mean")
        ...
        create_dataset_label = Label(self.window,
                                     text="Would you like to label the objects in the image \n with the interactive labeling tool?")
        ...
        inference_type_label = Label(self.window,
                                     text="What kind of inference would you like to do? \n (CNN, SVM, STATS)")
